<template>
    <div class="container lg:max-w-7xl mx-auto text-center mt-40">
        <div class="space-y-8">
            <h1 class="text-9xl dark:text-white text-gray-800 font-bold">
                500
            </h1>
            ...
            <p class="dark:text-gray-500 max-w-2xl mx-auto text-gray-800">
                Upps, Internal server error, this may occur because your hosting
                service has experienced a response failure
            </p>
