    ...
    <div class="accordion h-auto p-3">
        ...
        <div class="mt-5 w-full">
            ...
            <p class="mt-1 text-sm font-normal text-gray-400">
                Accordion use for vertically stacked content that with a click
                on a heading or down arrow, expands to show rolled up content.
            </p>
        </div>
            ...
            >
                        ...
                        <app-accordion>
                            ...
                            <template v-slot:content>
                                <p>
                                    ...
                                    consectetur adipisicing elit. Quia, porro.
                                    Non a excepturi, voluptatibus ipsam magnam,
                                    eligendi, accusantium ipsa quae quis
                                    praesentium voluptate saepe ullam sint ea
                ...
                <div class="accordion-packed">
                    ...
                    <p class="mt-1 dark:text-gray-200">
                        ...
                        above the title slot and add icon inside slot with
                        element
                        <a
